...
void swr_draw_image_abgr(uint32_t* buffer, int width, int height, uint32_t* img, int img_width, int img_height, int x, int y);
void swr_draw_image_argb(uint32_t* buffer, int width, int height, uint32_t* img, int img_width, int img_height, int x, int y);
void swr_draw_image_a(uint32_t *dest, int dest_width, int dest_height, uint8_t *img, int img_width, int img_height, uint32_t color, int img_x, int img_y);
